...
export const sendConfirmBook = async (to, body) => {
  ...
  const info = await transporter.sendMail({
    ...
    subject: "Confirmacion reserva", // Subject line
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 31px;font-family:'Cabin',sans-serif;" align="left">
                              ...
                              <div style="color: #e5eaf5; line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 28px; line-height: 39.2px;"><strong><span style="line-height: 39.2px; font-size: 28px;">THANK YOU FOR BOOKING WITH US</span></strong>
                                  </span>
                                </p>
                              </div>
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px 60px;font-family:'Cabin',sans-serif;" align="left">
                              ...
                              <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                ...
                                <p style="font-size: 14px; line-height: 160%;">DEAR CUSTOMER, </p>
                                <p style="font-size: 14px; line-height: 160%;">We thank you for your confidence in The Last Table, we are pleased to inform you of your reservation details:</p>
                                <p style="font-size: 14px; line-height: 160%;">&nbsp;</p>
                                <p style="font-size: 14px; line-height: 160%;">Time: ${body.hour}&nbsp;<br />Place: ${body.nameRest}</p>
                                <p style="font-size: 14px; line-height: 160%;">Address: ${body.addessRest} &nbsp;<br />Diners: ${body.diners}<br />Price per person: ${body.pUni} €<br />Total Price: ${body.pUni*body.diners} €</p>
                                <p style="font-size: 14px; line-height: 160%;"><br /><br />We hope you enjoy your experience,&nbsp;</p>
                                <p style="font-size: 14px; line-height: 160%;"><br />Please do not hesitate to contact us if you have any questions.</p>
                                <p style="font-size: 14px; line-height: 160%;"><br />Thank you</p>
                              </div>
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:41px 55px 18px;font-family:'Cabin',sans-serif;" align="left">
                              ...
                              <div style="color: #003399; line-height: 160%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 20px; line-height: 32px;"><strong>The Last Table .Inc</strong></span></p>
                              </div>
